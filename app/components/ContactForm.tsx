...
export function ContactForm({ csrfToken }: ContactFormProps) {
    return (
        <Form method="post" className={`${styles.form} font-['Inter']`}>
            ...
            <div className={styles.formGroup}>
                <label htmlFor="subject" className={`${styles.label} font-medium`}>
                    Subject
                </label>
                <input type="text" id="subject" name="subject" required className={`${styles.input} font-normal`} />
            </div>
            ...
            <div className={styles.formGroup}>
                ...
                <textarea id="message" name="message" rows={4} required className={`${styles.textarea} font-normal`} />
            </div>

            <div>
                <button type="submit" className={`${styles.button} font-medium`}>
                    Send Message
                </button>
            </div>
        </Form>
