...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Get in touch with Code Rage for your tech needs. Professional computer repair and web development services.",
    },
  ];
};
      ...
      <div className={styles.content}>
        <div className={styles.headerSection}>
          ...
          <p className={styles.subtitle}>
            Have a question or ready to start a project? I&apos;m here to help! Fill out the form below and I&apos;ll get back to you as soon as possible.
          </p>
        </div>
        <ContactForm />
      </div>
